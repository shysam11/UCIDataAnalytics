...
function updateToolTip(chosenXAxis, circlesGroup) {
  ...
  */
  ...
  circlesGroup.on("mouseover", function(datacircle) {
    toolTip.show(datacircle);
  })
    // onmouseout event
    .on("mouseout", function(datacircle, index) {
      toolTip.hide(datacircle);
    });
...
d3.csv("data.csv", function(err, data) {
  ...
  data.forEach(function(datap) {
    ...
    datap.noHealthInsurance = +datap.noHealthInsurance;
